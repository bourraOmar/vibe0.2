    ...
    <x-app-layout>
        <div class="max-w-4xl mx-auto px-6 py-10">
                ...
                <form action="{{ route('posts.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-4">
                        ...
                        <textarea name="content" id="content"
                            class="w-full px-4 py-2 bg-[#2a3647] text-white rounded-lg border border-gray-600 focus:ring-2 focus:ring-blue-500 focus:outline-none resize-none"
                    ...
                    <div class="mb-4">
                        ...
                        <input type="file" name="image" id="image"
                            class="w-full px-3 py-2 bg-[#2a3647] text-gray-300 rounded-lg border border-gray-600 focus:ring-2 focus:ring-blue-500 focus:outline-none">
                    </div>

                    <!-- Submit Button -->
                    <div class="flex justify-end">
                        <button type="submit"
                            class="bg-blue-500 hover:bg-blue-600 text-white font-medium px-5 py-2 rounded-lg transition-all">
                            Post
                        </button>
                    </div>
                </form>
            ...
            @forelse ($posts as $post)
                <!-- Post Card -->
                <div id="post-{{ $post->id }}"
                    class="bg-gray-800 my-10 rounded-lg shadow-lg mb-4 border border-gray-700 overflow-hidden">
                        ...
                        @if(Auth::id() === $post->user_id)
                            <div class="relative" x-data="{ open: false }">
                                ...
                                <div x-show="open" @click.away="open = false"
                                    ...
                                    <button hx-get="{{ route('posts.edit', $post->id) }}" hx-target="#post-{{ $post->id }}"
                                        hx-swap="outerHTML"
                                        class="block w-full px-4 py-2 text-sm text-gray-200 hover:bg-gray-600 flex items-center">
